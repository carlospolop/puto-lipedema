...
| seguridad/espacio | artefactos | el árbol bruto de 268 artefactos no se conserva en git; Qdrant guarda el contenido aprobado y el repositorio mantiene solo receipts resumidos, hashes, URLs y síntesis, sin credenciales ni URLs privadas |

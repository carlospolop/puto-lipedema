...
- [x] Se copió sin sobrescribir la carpeta completa de artefactos a `evidence/chack/recovery-20260829/` y se actualizarán el resumen, el launch log y el MANIFEST. No se iniciarán más equivalentes: las nuevas búsquedas fueron saturantes y solo refinan seguridad/redacción.

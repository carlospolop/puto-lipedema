...
const OUTDIR = '/home/tester/git/puto-lipedema/researches/2026-07-02_11-01-29-lipolisis-grasa-lipedema/chatgpt';
const TARGET = '6a462a0c-3a90-83eb-81e4-9cac79225d96';
const OUT = path.join(OUTDIR, 'chatgpt-deepresearch1-lipolisis-original.md');
const META = path.join(OUTDIR, 'chatgpt-deepresearch1-lipolisis-original.meta.json');
const LOG = path.join(OUTDIR, 'chatgpt-deepresearch1-lipolisis-monitor.log');
const EXPR = `(() => {

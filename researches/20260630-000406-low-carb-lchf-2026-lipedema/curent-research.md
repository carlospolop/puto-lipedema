...
- [x] Lanzar subagentes:
  ...
  - Batch `deleg_86eb4392`: Task 1 evidencia clínica completada e integrada; Task 2 seguridad/monitorización completada e integrada; Task 3 OSINT/SerpAPI terminó en timeout sin resumen utilizable.
...
- [x] Guardar `summary.md`, addendum tardío, actualizar `suggestions.md`, validar HTML/enlaces/search-index, commit y push a main.
  - Reabierto tras llegada tardía de subagentes: `subagents-late-addendum.md` creado; web/summary/suggestions parcheados; validación HTML/enlaces OK; `search-index.js` regenerado; commit/push en curso.
...
- 2026-06-30 00:41 CEST: intento de UI Deep Research no confirmó chip/iframe; se mantuvo como Pro normal. Error posterior detectado: las respuestas ChatGPT no eran inútiles; el fallo fue extracción incompleta por snapshot/`body.innerText` parcial.
- 2026-06-30 post-push: llegó async batch `deleg_86eb4392`. Integrados Task 1 y Task 2 en `subagents-late-addendum.md`; Task 3 OSINT/SerpAPI timeout. Nuevos puntos incorporados: PMID 38627016 como RCT primario LIPODIET, PMIDs 39574523/40125475/39566600/41479665, y cautelas SGLT2/insulina/sulfonilureas/embarazo/TCA/renal/hepático/gota/vesícula.
- 2026-06-30 corrección operativa: inspección estructurada de ChatGPT por CDP (`[data-message-author-role]` y `section[data-testid^="conversation-turn"]`) encontró salidas completas: `chatgpt-diets-literature-review.md` (24.5k chars), `chatgpt-keto-safety-checklist.md` (19.5k chars), `chatgpt-low-carb-translation.md` (14.9k chars). Skills `chatgpt-web-research-modes`, `master-research-orchestrator` y `lipedema-research-workflow` actualizadas para no repetir el error.
